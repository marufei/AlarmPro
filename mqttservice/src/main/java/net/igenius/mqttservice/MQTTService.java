...
public class MQTTService extends BackgroundService implements Runnable, MqttCallbackExtended {
    ...
    private static final String CHANNEL_ONE_ID="com.huikezk.alarmpro";
    private static final String CHANNEL_ONE_NAME="com.huikezk.alarmpro";
...
//        startForeground(startId,new Notification());
    ...
    /**
     * 修改通知设置  即可解决8.1以上系统开启通知闪退问题
     */
    public void notificationDispose(int startId){
