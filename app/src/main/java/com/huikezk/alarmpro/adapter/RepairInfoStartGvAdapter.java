 ...
 * update：
 */
public class RepairInfoStartGvAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<String> listData=new ArrayList<>();
    public RepairInfoStartGvAdapter(Context context){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        PicassoUtlis.Cornersimg("file://"+listData.get(i),viewHolder.item_repair_img, Const.CONNER_BIG);
        return view;
    }
