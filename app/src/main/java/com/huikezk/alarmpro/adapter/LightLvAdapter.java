 ...
 * update：
 */
public class LightLvAdapter extends BaseAdapter {
    private Context context;
    private List<LightEntity.DataBean> list=new ArrayList<>();

    public LightLvAdapter(Context context) {
        this.context = context;
    }

    public void setListData(List<LightEntity.DataBean> list) {
        this.list=list;
    }
