...
import static com.huikezk.alarmpro.service.MyMQTTCommand.BROADCAST_CONNECTION_SUCCESS;
 ...
 * update：
 */
public abstract class MyMQTTReceiver extends WakefulBroadcastReceiver {
    @Override
